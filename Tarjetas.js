    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
      ...
      <div class="bg-white shadow-md rounded-xl overflow-hidden hover:shadow-xl transition">
        ...
        <div class="p-4">
          ...
          <p class="text-gray-600">Superbike - 1000cc</p>
        </div>
      </div>
      ...
      <div class="bg-white shadow-md rounded-xl overflow-hidden hover:shadow-xl transition">
        ...
        <div class="p-4">
          ...
          <p class="text-gray-600">Superbike - 1100cc</p>
        </div>
      </div>
      ...
      <div class="bg-white shadow-md rounded-xl overflow-hidden hover:shadow-xl transition">
        ...
        <div class="p-4">
          ...
          <p class="text-gray-600">Supersport - 600cc</p>
        </div>
      </div>
      ...
      <div class="bg-white shadow-md rounded-xl overflow-hidden hover:shadow-xl transition">
        ...
        <div class="p-4">
          ...
          <p class="text-gray-600">Custom - 1200cc</p>
        </div>
      </div>
      ...
      <div class="bg-white shadow-md rounded-xl overflow-hidden hover:shadow-xl transition">
        ...
        <div class="p-4">
          ...
          <p class="text-gray-600">Adventure - 1250cc</p>
        </div>
      </div>
